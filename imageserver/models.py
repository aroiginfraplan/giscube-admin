...
class ServiceGroupPermission(models.Model):
    ...
    group = models.ForeignKey(Group, related_name='group_permissions', verbose_name=_('Group'), on_delete=models.CASCADE)
...
class ServiceUserPermission(models.Model):
    ...
    user = models.ForeignKey(User, related_name='service_user_permissions', verbose_name=_('User'), on_delete=models.CASCADE)
    can_view = models.BooleanField(_('Can view'), default=True)
