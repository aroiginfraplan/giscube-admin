...
RESOURCE_SERVER_INTROSPECTION_CREDENTIALS = os.environ.get(
    'RESOURCE_SERVER_INTROSPECTION_CREDENTIALS'),

if RESOURCE_SERVER_AUTH_TOKEN:
    OAUTH2_PROVIDER['RESOURCE_SERVER_AUTH_TOKEN'] = RESOURCE_SERVER_AUTH_TOKEN
elif RESOURCE_SERVER_INTROSPECTION_CREDENTIALS:
    OAUTH2_PROVIDER['RESOURCE_SERVER_INTROSPECTION_CREDENTIALS'] = tuple(
